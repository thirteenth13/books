...
public final class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        Button navLibrary = findViewById(R.id.nav_library), navFavorites = findViewById(R.id.nav_favorites), navRecent = findViewById(R.id.nav_recent), navSettings = findViewById(R.id.nav_settings);
        ...
        navLibrary.setOnClickListener(v -> startBookPaging("Книги", catalogDatabase::listBooks));
        navFavorites.setOnClickListener(v -> startBookPaging("Обране", catalogDatabase::listFavorites));
        navRecent.setOnClickListener(v -> new AlertDialog.Builder(this).setTitle("Нещодавні").setMessage("Історію відкритих книг підключимо наступним кроком.").setPositiveButton("OK", null).show());
    ...
    private void showBookDetails(BookItem book){boolean favorite=catalogDatabase.isFavorite(book);BookDetailsPage.show(this,book,favorite,()->openBook(book),()->startBookPaging(book.author,(l,o)->catalogDatabase.booksByAuthor(book.author,l,o)),()->startBookPaging(book.series,(l,o)->catalogDatabase.booksBySeries(book.series,l,o)),()->catalogDatabase.toggleFavorite(book));}
